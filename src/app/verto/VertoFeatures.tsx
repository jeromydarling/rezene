...
const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    points: [
      ...
      "Cloth-physics drape preview on twenty-three blocks — tees and briefs to tailored coats — that grounds a photoreal render",
