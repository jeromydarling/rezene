...
const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    points: [
      ...
      "Cloth-physics drape preview on nine blocks — tees to trousers — that grounds a photoreal render",
