...
const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    points: [
      ...
      "Cloth-physics drape preview on sixteen blocks — tees to circle skirts — that grounds a photoreal render",
