...
const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    points: [
      ...
      "Cloth-physics drape preview on twenty-one blocks — tees to tailored coats — that grounds a photoreal render",
