...
const MODERN_SHOP: { group: string; items: [string, string][] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      ["The Verto School", "Courses in tailoring, seamstressing and fashion from the era's own masters — timed lessons, server-graded examinations, and certificates verified by real work in your studio."],
