...
**The School** (its own section in the sidebar) is a working education in the three crafts behind your shop — tailoring, seamstressing, and fashion — taught from the golden-age masters. Every course is adapted from verified public-domain books (published before 1931): the Woman's Institute lessons, the great cutting systems, Nystrom's founding economics of fashion. We modernized the language, not the craft; each lesson links its original on the Internet Archive — and the lessons are **illustrated with the books' own plates**: Vincent's trouser drafts, Madison's balance diagrams, the Institute's stitch figures, Racinet's color costume plates, each captioned with its book and placed at the paragraph it teaches.

## How a course works

1. **Enroll** — courses are included with your shop; there's nothing to buy.
2. **Read the lessons, in order.** Each course runs **twelve lessons** — a real correspondence course adapted from the whole book, many hours of study, not an afternoon. Lessons unlock sequentially, and the school credits **real reading time** — a progress rail fills as you read, and each lesson has checkpoint questions woven in. You can't skip, and you can't skim your way through: completion is earned on the server, not clicked in the browser.
